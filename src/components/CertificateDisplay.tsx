          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0">
            <defs>
              ...
              <pattern id="guilloche" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                <circle cx="50" cy="50" r="2" fill="none" stroke="#1e40af" strokeWidth="0.5" />
                <path d="M 10 50 Q 50 10, 90 50 T 10 50" stroke="#1e40af" strokeWidth="0.3" fill="none" />
                <path d="M 10 50 Q 50 90, 90 50 T 10 50" stroke="#1e40af" strokeWidth="0.3" fill="none" />
              </pattern>
              
              {/* Wave lines pattern */}
              <pattern id="waves" x="0" y="0" width="200" height="50" patternUnits="userSpaceOnUse">
                <path d="M 0 25 Q 50 15, 100 25 T 200 25" stroke="#1e40af" strokeWidth="0.5" fill="none" opacity="0.3" />
                <path d="M 0 25 Q 50 35, 100 25 T 200 25" stroke="#1e40af" strokeWidth="0.5" fill="none" opacity="0.3" />
              </pattern>
              
              {/* Diagonal lines */}
              <pattern id="diagonal" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
                <line x1="0" y1="0" x2="50" y2="50" stroke="#1e40af" strokeWidth="0.2" opacity="0.2" />
              </pattern>
            </defs>
            ...
            {/* Decorative corners */}
            <circle cx="20" cy="20" r="15" fill="none" stroke="#1e40af" strokeWidth="1" opacity="0.2" />
            <circle cx="calc(100% - 20)" cy="20" r="15" fill="none" stroke="#1e40af" strokeWidth="1" opacity="0.2" />
            <circle cx="20" cy="calc(100% - 20)" r="15" fill="none" stroke="#1e40af" strokeWidth="1" opacity="0.2" />
            <circle cx="calc(100% - 20)" cy="calc(100% - 20)" r="15" fill="none" stroke="#1e40af" strokeWidth="1" opacity="0.2" />
            
            {/* Border decorations */}
            <rect x="10" y="10" width="30" height="3" fill="#1e40af" opacity="0.3" />
            <rect x="calc(100% - 40)" y="10" width="30" height="3" fill="#1e40af" opacity="0.3" />
            <rect x="10" y="calc(100% - 13)" width="30" height="3" fill="#1e40af" opacity="0.3" />
            <rect x="calc(100% - 40)" y="calc(100% - 13)" width="30" height="3" fill="#1e40af" opacity="0.3" />
          </svg>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-6">
            ...
            <div className="my-6">
              ...
              <p className="text-xl text-gray-600 font-medium">Mã sinh viên: {certificate.studentId}</p>
            </div>
            ...
            <div className="border-t-2 border-blue-900 pt-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-sm font-semibold text-gray-700">NGƯỜI PHÁT HÀNH</p>
                  {certificate.issuer && (
          ...
          <div className="text-center mt-6">
            <p className="text-xs text-gray-500">
              Powered by <span className="font-bold text-blue-700">CertiChain</span> - Blockchain Verification System
            </p>
          </div>
        </div>
      </div>
